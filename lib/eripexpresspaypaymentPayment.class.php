...
class eripexpresspaypaymentPayment extends waPayment implements waIPayment
{
    ...
    public function payment($payment_form_data, $order_data, $auto_submit = false)
    {
        ...
        $hidden_fields = array(
            ...
            'Currency' => "933",
            'Info' => $this->ERIP_EXPRESSPAY_INFO,
            'ReturnType' => "json",
        ...
        if (isset($respone['Errors'])){
            ...
            $view = wa()->getView();
            $view->assign('order_id', str_replace('#', '', $order_data['id_str']));
            $view->assign('erip_path', $this->ERIP_EXPRESSPAY_ERIP_PATH);
            echo ($this->path);
